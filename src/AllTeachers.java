 ...
 public void showRecord(){
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addComponent(grade, javax.swing.GroupLayout.PREFERRED_SIZE, 220, javax.swing.GroupLayout.PREFERRED_SIZE)))))
    ...
    private void gradeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_gradeActionPerformed
        try{
            ...
            {
                String query ="SELECT * FROM teacher    WHERE grade ='1A'";
                ResultSet rs = stmt.executeQuery(query);
                view.setModel(DbUtils.resultSetToTableModel(rs));
            }
            if(grade.getSelectedItem().equals("1B"))
            {
                String query ="SELECT * FROM teacher WHERE grade = '1B'";
                ResultSet rs = stmt.executeQuery(query);
                view.setModel(DbUtils.resultSetToTableModel(rs));
            }
            if(grade.getSelectedItem().equals("1C"))
            {
                String query ="SELECT * FROM teacher WHERE grade = '1C'";
                ResultSet rs = stmt.executeQuery(query);
                view.setModel(DbUtils.resultSetToTableModel(rs));
            }
